...
class CoinCheck:
    ...
    def __init__(self, accessKey2, secretKey2, options = {}):
        self.accessKey2 = accessKey2
        self.secretKey2 = secretKey2
    ...
    def setSignature(self, path):
        ...
        message = nonce + url
        signature = hmac.new(self.secretKey2.encode('utf-8'), message.encode('utf-8'), hashlib.sha256).hexdigest()
        self.request_headers.update({
                'ACCESS-NONCE': nonce,
                'ACCESS-KEY': self.accessKey2,
